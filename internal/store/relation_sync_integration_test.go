...
// independent *SQLiteStore instances (Machine A and Machine B) without a real cloud
...
func setupIntegrationStores(t *testing.T) (machineA, machineB *SQLiteStore, syncObsX, syncObsY string) {
	t.Helper()
...
func transferMutations(t *testing.T, src, dst *SQLiteStore) int {
	t.Helper()
