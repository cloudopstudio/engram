// Package syncguidance provides error classification and human-readable
// repair guidance for known repairable cloud sync failures.
//
// Guidance is appended to failure messages so operators know how to recover
// without consulting external documentation. All functions are pure (no I/O,
// no state mutations) and are safe to call from goroutines.
...
// Guidance returns the canonical repair instructions for a given project.
