...
// runDiagnostics is an injectable function for testing. The real implementation
// runs the diagnostic runner. Tests can override this variable.
var runDiagnostics = func(ctx context.Context, s store.Store, project, check string) (diagnostic.Report, error) {
